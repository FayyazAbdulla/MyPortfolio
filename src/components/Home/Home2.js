...
function Home2() {
  ...
  <p className="home-about-body">
    ...
    <br />
    <b className="purple">Upcoming Projects:</b>
    <ul>
      <li>
        <b className="purple">AI-Powered Job Application Analyzer</b>: 
        A tool that uses AI to analyze resumes and job postings, offering insights 
        on how well a candidate's resume aligns with the job requirements.
      </li>
      <li>
        <b className="purple">IoT-based Smart Home Automation System</b>: 
        A system designed to automate home appliances using sensors and 
        voice control, integrating with platforms like Google Home and Alexa.
      </li>
    </ul>
    <br />
    I am passionate about applying{" "}
