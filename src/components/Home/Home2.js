        ...
        <Row>
          <Col md={8} className="home-about-description">
            ...
            <p className="home-about-body">
              ...
              <ul>
                <li>React, Node.js, MongoDB, Python, PHP</li>
              ...
              <br />
              One of my most rewarding experiences during my final year was
              serving as the <b className="purple">Start-up Manager</b> for the
              <b className="purple">
                {" "}
              ...
              <ul>
                ...
                <li>
                  ...
                  a secure backend using <b className="purple">Firebase</b>.
                </li>
                <li>
                  Integrated a{" "}
              ...
              <ul>
                <li>Leather Fashion Shop Management Web Application</li>
                <li>Delivery Service Web Application</li>
                <li>Debra Event Management</li>
                <li>Tomato adventure Quest game</li>
              </ul>
              <br />
